...
- **Global scope**: `C:/Users/MSI/Projeect_A.E/My project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/MSI/Projeect_A.E/My project/.claude/notes/`)
...
2. Glob `C:/Users/MSI/Projeect_A.E/My project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/MSI/Projeect_A.E/My project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/MSI/Projeect_A.E/My project/.claude/notes/` — works in any directory
